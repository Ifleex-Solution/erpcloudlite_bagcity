...
class Invoice extends MX_Controller
{
    ...
    function touch_invoice_form($id = null)
    {
        ...
        $data['vk_enable']    = $ws ? (int)$ws->vk_enable : 1;
         ...
         if ($this->permission1->method('touch_invoice', 'create')->access()) {
    ...
    ";
        ...
        echo json_encode(['success' => true, 'html' => $this->_build_sales_return_print($inserted_id)]);
    }
...
";
        ...
        echo json_encode(['success' => true, 'html' => $this->_build_sales_return_print($this->input->post('id', TRUE))]);
    }
