...
";
    ...
    ";
        ...
        echo json_encode(['success' => true, 'html' => $this->_build_purchase_return_print($inserted_id)]);
    }
...
";
        ...
        echo json_encode(['success' => true, 'html' => $this->_build_purchase_return_print($this->input->post('id', TRUE))]);
    }
